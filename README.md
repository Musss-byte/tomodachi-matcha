...
<body class="text-green-900">
  ...
  <!-- MODAL QRIS, TRANSFER, BUKTI TRANSAKSI tetap sama -->
...
function addToCart(name, price){
  ...
  document.getElementById("cart-count").innerText=cart.length; document.getElementById("cart-count").classList.remove("hidden");
  renderCart();
}
    ...
    html+=`
      <div class="flex justify-between border-b py-2 items-center">
        ...
        <div class="flex items-center gap-2">
          <button onclick="updateQty(${i},-1)" class="bg-gray-200 px-2 rounded">-</button>
          <span>${item.qty}</span>
          <button onclick="updateQty(${i},1)" class="bg-gray-200 px-2 rounded">+</button>
...
// fungsi cart-btn, closeCart, openCheckout, closeCheckout, pilihMetode, uploadBuktiFoto, sendWa, ambilLokasiPembeli, hitungJarak, getLocation, closeBukti tetap sama
  </script>
</body>
</html>
